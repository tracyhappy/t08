...
<%
   ...
   String strSql="select * from BDMS_qa_daily_grp where date between '"+ sdate +"'and'"+ edate + "' and grp='" + grpname + "' group by grp,dep,date,qn,suresub,sureplus,plansub,planplus,profit,avgqa,sumqa,basicqa,stan order by date asc";   
...
<td><%=(fnum1.format((rs.getFloat(13)*100))+ "%")%></td>
</tr>
<%}
%>
</tbody>
