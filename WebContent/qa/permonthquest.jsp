...
<%
   ...
   String strperqa=qu.getperqaString(table,grpname,username);
   ResultSet rs=rst.getResult(strperqa);
...
<td><%=fnum1.format(rs.getFloat(11)) %></td>
<td><%=fnum2.format(rs.getFloat(12)) %></td>
<td><%=fnum2.format(rs.getFloat(13)) %></td>
<td><%=(fnum1.format((rs.getFloat(14)*100))+ "%")%></td>
</tr>
<%}
%>
</tbody>
