...
<body>
<%
   String table="BDMS_eff_daily_per";
   ...
   String strpereff=qu.getpereffString(table,grpname,username);
   ResultSet rs=rst.getResult(strpereff);
...
<td><%=(fnum1.format((rs.getFloat(9)*100))+ "%")%></td>
<td><%=(fnum1.format((rs.getFloat(10)*100))+ "%")%></td>
</tr>
<%}
%>
</tbody>
