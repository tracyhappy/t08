...
<body>
<%
   String table="BDMS_eff_daily_grp";
   String sdate=request.getParameter("sdate");
   String edate=request.getParameter("edate");
   String depid=trans.trans(request.getParameter("depid"));
   String grpname=trans.trans(request.getParameter("grpname"));
   qu.setdepid(depid);qu.setgrpname(grpname);qu.setSdate(sdate);qu.setEdate(edate);
   String strgrpeff=qu.getgrpeffString(table, depid, grpname);
   ResultSet rs=rst.getResult(strgrpeff);
