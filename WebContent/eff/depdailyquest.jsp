...
<%
   ...
   String strSql="select * from BDMS_eff_daily_dep where date between '"+ sdate +"'and'"+ edate + "' and dep='" + depid + "' group by dep,date,IB,ATT,AAH,LT,DR,TR,tiaoxian,idc,odc,tranc,acdttime,idttime,odttime,nrttime,wur,tranr,renshu order by date asc";  
...
<td><%=fnum2.format(rs.getFloat(3)) %></td>
...
<td><%=(fnum1.format((rs.getFloat(8)*100))+ "%")%></td>
</tr>
<%}
%>
</tbody> 
